    ...
    <div className="w-full bg-background-soft rounded-3xl p-6 md:p-10 shadow-soft border border-border">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="bg-card shadow-medium border border-border rounded-3xl p-6 relative">
          ...
          <div className="space-y-3 mt-10 text-sm text-foreground leading-relaxed">
            <p><strong>Patient Name – </strong>{t.name}</p>
            <p><strong>Treatment Name – </strong>{t.treatment}</p>
            <p><strong>Duration – </strong><span className="font-semibold">{t.duration}</span></p>
            <p><strong>Clinic – </strong>{t.clinic}</p>
