...
"[project]/modernfronted/HairGrowth-Clinic/app/payment-method/online/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OnlinePaymentPage() {
    _s();
    const params = (0, __TURBOPACK__imported__module__$5b$project$5d2f$modernfronted$2f$HairGrowth$2d$Clinic$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"])();
    ...
    const { createAppointmentOrderSuccess, orderDetails } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$modernfronted$2f$HairGrowth$2d$Clinic$2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "OnlinePaymentPage.useSelector": (state)=>state.appointment
    }["OnlinePaymentPage.useSelector"]);
    const [razorpayLoaded, setRazorpayLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$modernfronted$2f$HairGrowth$2d$Clinic$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isAppointment, setIsAppointment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$modernfronted$2f$HairGrowth$2d$Clinic$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$modernfronted$2f$HairGrowth$2d$Clinic$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OnlinePaymentPage.useEffect": ()=>{
            if (appointmentId && appointmentAmount && !orderId) {
                ...
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$modernfronted$2f$HairGrowth$2d$Clinic$2f$redux$2f$slices$2f$appointmentSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createAppointmentOrder"])({
                    appointmentId,
    ...
    const handlePayment = ()=>{
        ...
        const options = {
            ...
            handler: function(response) {
                // Payment success
                if (isAppointment) {
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$modernfronted$2f$HairGrowth$2d$Clinic$2f$redux$2f$slices$2f$appointmentSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyAppointmentPayment"])({
                        appointmentId,
                    ...
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$modernfronted$2f$HairGrowth$2d$Clinic$2f$redux$2f$slices$2f$registerSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyPayment"])({
                        consultantId,
                        razorpay_payment_id: response.razorpay_payment_id,
                        razorpay_order_id: response.razorpay_order_id,
                        razorpay_signature: response.razorpay_signature
...
_s(OnlinePaymentPage, "UF+cCMPbtb3I8PeGkxih0gESiXk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$modernfronted$2f$HairGrowth$2d$Clinic$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"],
...
//# sourceMappingURL=modernfronted_HairGrowth-Clinic_app_payment-method_online_page_jsx_f6f7103e._.js.map