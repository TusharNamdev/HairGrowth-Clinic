...
"[project]/app/text-reveal.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TextReveal() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const selector = "h1, h2, h3, h4, h5, h6, p, span, li, a, button, label, strong, blockquote";
        const revealElements = ()=>document.querySelectorAll(selector).forEach((el)=>{
                ...
                if (rect.top < windowHeight * 0.9 && rect.bottom > windowHeight * 0.1) {
                    ...
                    // remove visible to allow re-animation
        ...
        // run on route change (App Router)
        window.addEventListener("resize", revealElements);
        window.addEventListener("load", revealElements);
        const interval = setInterval(revealElements, 500); // catches new elements
        return ()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7dbe2820._.js.map